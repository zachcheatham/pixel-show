...
public class Constants
{
    ...
    public static final String TRANSLATION_APP_TITLE = "app.title";
    public static final String TRANSLATION_MENU_FILE = "menu.file.file";
    public static final String TRANSLATION_ACTION_OPEN_SHOW = "action.open_show";
    public static final String TRANSLATION_ACTION_SAVE_SHOW = "action.save_show";
    public static final String TRANSLATION_MENU_FILE_EXIT = "menu.file.exit";
    ...
    public static final String TRANSLATION_FILE_TYPE_WAV = "file_type.wav";
    public static final String TRANSLATION_FILE_TYPE_SHW = "file_type.shw";
    public static final String TRANSLATION_ACTION_PLAY = "action.play";
    public static final String TRANSLATION_ACTION_PAUSE = "action.pause";
    public static final String TRANSLATION_MENU_LAYERS = "menu.layers.layers";
    public static final String TRANSLATION_ACTION_ZOOM_IN = "action.zoom_in";
    public static final String TRANSLATION_ACTION_ZOOM_OUT = "action.zoom_out";
